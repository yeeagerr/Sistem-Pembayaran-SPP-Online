...
<body>
	...
	<div class="container">
		...
		if (isset($_REQUEST['submit'])) {
			...
			$sql = mysqli_query($conn, "SELECT iduser,username,admin,fullname FROM user WHERE username='$username' AND password=md5('$password')");
		...
		?>
			<form class="form-signin" method="post" action="" role="form">
				...
				?>
				<h2 class="form-signin-heading"><span class="glyphicon glyphicon-tags"></span> SPP Online</h2>

...
<div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
  <div class="container">
	<div class="navbar-header">
	  ...
	  <a class="navbar-brand" href="#"><span class="glyphicon glyphicon-tags"></span> SPP Online</a>
	</div>
	<div class="navbar-collapse collapse">
	  <ul class="nav navbar-nav">
		...
		<li class="dropdown">
		  ...
		  <ul class="dropdown-menu">
			<li><a href="./admin.php?hlm=master&sub=jurusan">Prodi</a></li>
			<li><a href="./admin.php?hlm=master&sub=siswa">Mahasiswa</a></li>
